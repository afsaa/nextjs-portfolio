...
/**
 * __useGetAllExpsQuery__
 *
 * To run a query within a React component, call `useGetAllExpsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllExpsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllExpsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllExpsQuery(baseOptions?: Apollo.QueryHookOptions<GetAllExpsQuery, GetAllExpsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllExpsQuery, GetAllExpsQueryVariables>(GetAllExpsDocument, options);
      }
export function useGetAllExpsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllExpsQuery, GetAllExpsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllExpsQuery, GetAllExpsQueryVariables>(GetAllExpsDocument, options);
        }
export type GetAllExpsQueryHookResult = ReturnType<typeof useGetAllExpsQuery>;
export type GetAllExpsLazyQueryHookResult = ReturnType<typeof useGetAllExpsLazyQuery>;
export type GetAllExpsQueryResult = Apollo.QueryResult<GetAllExpsQuery, GetAllExpsQueryVariables>;